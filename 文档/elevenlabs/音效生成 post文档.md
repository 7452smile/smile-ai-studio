...
paths:
  /v1/ai/sound-effects:
    post:
      tags:
        - sound-effects
      summary: Sound Effects - Generate from text
      description: >
        Create realistic sound effects from text descriptions using AI.


        Generate high-quality audio sound effects based on your text prompts.
        Perfect for video production, game development, podcasts, and multimedia
        projects.
      operationId: create_sound_effects_task
      requestBody:
        content:
          application/json:
            examples:
              basic:
                summary: Basic sound effect generation
                value:
                  text: A cat meowing
                  duration_seconds: 5
              advanced:
                summary: Advanced with loop and influence
                value:
...
components:
  schemas:
    request_4:
      properties:
        text:
          description: The text to convert to sound effects
          example: A cat meowing
          maxLength: 2500
          type: string
        loop:
          default: false
        ...
        prompt_influence:
          default: 0.3
          description: >-
            The influence of the prompt on the generated audio. A value between
            0 and 1.
          example: 0.3
          maximum: 1
          minimum: 0
