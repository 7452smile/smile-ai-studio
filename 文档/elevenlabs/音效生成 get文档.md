...
````yaml get /v1/ai/sound-effects/{task-id}
openapi: 3.0.0
info:
  description: >-
...
security:
  - apiKey: []
paths:
  /v1/ai/sound-effects/{task-id}:
    get:
      tags:
        - sound-effects
      summary: Sound Effects - Get task status
      description: Get the status of one sound-effects task
      operationId: get_sound_effects_task_status
      parameters:
