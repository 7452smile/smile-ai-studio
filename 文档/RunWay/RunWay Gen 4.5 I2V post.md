...
````yaml post /v1/ai/image-to-video/runway-4-5
openapi: 3.0.0
info:
  description: >-
...
paths:
  /v1/ai/image-to-video/runway-4-5:
    post:
      tags:
        - image-to-video
      summary: Create video from image - RunWay Gen 4.5
      description: >
        Generate high-quality videos from images using RunWay Gen 4.5 model.
        ...
        **Use cases:** Product animations, social media content, marketing
        videos, and bringing photos to life.
      operationId: create_video_runway_45_i2v
      requestBody:
        content:
          application/json:
            examples:
              all-params:
                $ref: '#/components/examples/request-runway-4-5-i2v-all-params'
              required-only:
                $ref: '#/components/examples/request-runway-4-5-i2v-required-params'
            schema:
              $ref: '#/components/schemas/i2v-request'
        required: true
      responses:
        '200':
          content:
...
components:
  examples:
    request-runway-4-5-i2v-all-params:
      summary: >-
        Request - Generate video from image using RunWay Gen 4.5 (all
        parameters)
      value:
        image: >-
          https://storage.googleapis.com/fc-freepik-pro-rev1-eu-static/landing-api/examples/freepik__upload__53227.png
        prompt: >-
          The subject slowly opens their eyes and smiles warmly, with a gentle
          camera zoom
        ratio: '1280:720'
        duration: 8
        seed: 12345
        webhook_url: https://example.com/webhook
    request-runway-4-5-i2v-required-params:
      summary: Request - Generate video from image using RunWay Gen 4.5 (required only)
      value:
        image: >-
          https://storage.googleapis.com/fc-freepik-pro-rev1-eu-static/landing-api/examples/freepik__upload__53227.png
        prompt: The camera slowly pans across the scene revealing more details
    200-task-created:
  ...
  schemas:
    i2v-request:
      properties:
        ...
        image:
          description: >-
            Source image for video generation. Supports Base64 encoding or HTTPS
            URL (must be publicly accessible).
          example: https://example.com/image.jpg
          type: string
        prompt:
          description: >-
            Text prompt describing the desired motion and video content. Maximum
            2000 characters.
          example: The eagle spreads its wings and gracefully takes flight
          maxLength: 2000
          type: string
        ratio:
        ...
        seed:
          description: >-
            ...
            with identical parameters to generate the same video.
          maximum: 4294967295
          minimum: 0
          type: integer
      required:
