...
````yaml get /v1/ai/image-to-video/runway-4-5/{task-id}
openapi: 3.0.0
info:
  description: >-
...
security:
  - apiKey: []
paths:
  /v1/ai/image-to-video/runway-4-5/{task-id}:
    get:
      tags:
        - image-to-video
      summary: RunWay Gen 4.5 I2V - Get task status
      description: >-
        Retrieve the status and result of a specific RunWay Gen 4.5
        image-to-video task by its task ID.
      operationId: get_runway_45_i2v_task
      parameters:
