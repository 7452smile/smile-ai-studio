...
````yaml get /v1/ai/text-to-video/wan-v2-6-720p/{task-id}
openapi: 3.0.0
info:
  description: >-
...
security:
  - apiKey: []
paths:
  /v1/ai/text-to-video/wan-v2-6-720p/{task-id}:
    get:
      tags:
        - text-to-video
      summary: WAN 2.6 T2V 720p - Get task status
      description: Get the status of a WAN 2.6 Text-to-Video 720p task
      parameters:
