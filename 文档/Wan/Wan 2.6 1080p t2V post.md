...
````yaml post /v1/ai/text-to-video/wan-v2-6-1080p
openapi: 3.0.0
info:
  description: >-
...
paths:
  /v1/ai/text-to-video/wan-v2-6-1080p:
    post:
      tags:
        - text-to-video
      summary: WAN 2.6 1080p - Create video from text
      description: Generate a 1080p video from text prompt using the WAN 2.6 model.
      operationId: create_video_wan_v26_t2v_1080p
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/t2v-wan-v26-1080p-request-content'
        required: true
      responses:
        '200':
          content:
...
components:
  schemas:
    t2v-wan-v26-1080p-request-content:
      allOf:
        - $ref: '#/components/schemas/wan-v26-t2v-base'
      description: Generate 1080p video from text prompt using WAN v2.6 model
      title: Text to Video - WAN v2.6 1080p
    ...
    wan-v26-t2v-base:
      ...
      required:
        - prompt
      title: WAN v2.6 Text-to-Video Base
      type: object
    task:
      example:
        task_id: 046b6c7f-0b8a-43b9-b35d-6489e6daee91
