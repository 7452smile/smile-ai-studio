...
paths:
  /v1/ai/image-to-video/pixverse-v5:
    post:
      tags:
        - image-to-video
      summary: PixVerse V5 - Create video from image
      description: >-
        Generate a video using the PixVerse-V5 model. Resolution is specified in
        the request body.
      operationId: create_pixverse_v5_video
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/request_1'
        required: true
      responses:
        '200':
          content:
