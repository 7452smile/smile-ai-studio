...
````yaml post /v1/ai/video/seedance-1-5-pro-1080p
openapi: 3.0.0
info:
  description: >-
...
security:
  - apiKey: []
paths:
  /v1/ai/video/seedance-1-5-pro-1080p:
    post:
      tags:
        - video
      summary: Seedance 1.5 Pro 1080p - Create video from text or image
      description: >-
        Generate 1080p video with synchronized audio using Seedance 1.5 Pro.
        Supports text-to-video and image-to-video with lip-sync, dialogue,
        foley, and music generation.
      operationId: create_video_seedance_1_5_pro_1080p
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/seedance-1-5-pro-request'
        required: true
      responses:
        '200':
          content:
  ...
  schemas:
    seedance-1-5-pro-request:
      properties:
        ...
        image:
          description: >-
            Optional image to use as first frame for image-to-video generation.
            Supported formats: URL of the image or base64 encoding.
          format: byte
          type: string
        prompt:
          description: >-
            The text content used for the video generation including dialogue,
            sounds, and scene description.
          example: A person saying 'Hello world' while waving at the camera
          maxLength: 2000
          type: string
        duration:
          default: 5
        ...
        generate_audio:
          default: true
          description: >-
            Whether to generate synchronized audio (dialogue, foley, music) from
            the prompt
          type: boolean
        camera_fixed:
          default: false
          description: Whether the camera position should be fixed (tripod shot)
          type: boolean
        aspect_ratio:
