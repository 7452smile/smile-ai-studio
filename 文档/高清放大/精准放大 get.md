...
````yaml get /v1/ai/image-upscaler-precision-v2/{task-id}
openapi: 3.0.0
info:
  description: >-
...
security:
  - apiKey: []
paths:
  /v1/ai/image-upscaler-precision-v2/{task-id}:
    get:
      tags:
        - upscaler-precision
      summary: Upscaler Precision V2 - Get task status
      description: >-
        Returns the current status and output URL of a specific precision
        upscaler V2 task. The output URL is included only if the task has
        completed successfully.
      operationId: getAiImageUpscalerPrecisionV2Task
      parameters:
